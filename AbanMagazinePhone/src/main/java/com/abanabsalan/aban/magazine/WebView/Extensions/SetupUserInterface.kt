...
fun BuiltInWebView.showPopupPreferences() {
    ...
    val circularReveal: Animator = ViewAnimationUtils.createCircularReveal(browserViewBinding.preferencePopupInclude.root,
        (browserViewBinding.optionMenus.x.toInt() + (browserViewBinding.optionMenus.width / 2)),
        (browserViewBinding.optionMenus.y.toInt() - (browserViewBinding.optionMenus.height)),
        (browserViewBinding.optionMenus.height.toFloat() / 2),
        finalRadius.toFloat())

    circularReveal.duration = 1111
    circularReveal.interpolator = AccelerateInterpolator()

    browserViewBinding.preferencePopupInclude.root.visibility = View.VISIBLE
    circularReveal.start()
    circularReveal.addListener(object : Animator.AnimatorListener {
        override fun onAnimationRepeat(animation: Animator?) {
...
fun BuiltInWebView.hidePopupPreferences() {
